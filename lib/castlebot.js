...
var CastleBot = function Constructor(settings) {
    ...
    this.goFundMe = this.settings.goFundMe ||"https://www.gofundme.com/juanislas"// "https://www.gofundme.com/castle37";
    this.refreshRate = this.settings.refreshRate || 15 // 5 mins
    this.user = null;
    this.db = null;
};
...
CastleBot.prototype._isUpdateRequest = function (message) {
    var self = this;
    return self._messageContains(message, 'update') || self._messageContains(message, 'total')
};
