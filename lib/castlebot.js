...
CastleBot.prototype._isCastleUrl = function (message) {
    var self = this;
    return self._messageContains(message, 'castle url') || 
           self._messageContains(message, 'castle gofundme') ||
           self._messageContains(message, 'castle page') 
};
