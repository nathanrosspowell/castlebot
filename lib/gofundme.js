...
function getDonorData(html, lastCount) {
    ...
    var donations = getNumber($('div > div.donorscroll > span:nth-child(4)').text());
    donations += 1; 
    var nums = $('div > div.donorscroll > span:nth-child(3)').text();
...
function recurseDonors(page, lastCount, callback, preDonators) {
    ...
    page.evaluate(function() {
        ...
        if (newData.earlyBailout) {
            ...
            page.evaluate(function(){
                var a = document.querySelector("div > div.donorscroll > a.lr.pright.donationsPage");
                var finished = a === null;
                if ( !finished ) {
...
console.log("content")
                    ...
                    var $ = cheerio.load(content),
                            ...
                            donations = parseInt($('div.donate_right > div > div.donorscroll > span:nth-child(4)').text()),
...
console.log("lastCount")
                    var lastCount = input.lastCount !== "undefined" ? 0 : input.lastCount
console.log("log")
